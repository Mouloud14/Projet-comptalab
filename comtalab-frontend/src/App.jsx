// src/App.jsx (Nettoyé et Corrigé)
...
function App() {
    ...
    // (dashboardData et lowStock sont supprimés d'ici)
    ...
    const refreshTransactions = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error("Erreur récupération transactions.");
                setTransactions([]);
            }
        } catch (error) {
    ...
    // (fetchDashboardData et fetchLowStock sont supprimés d'ici)
    ...
    // --- Calculs ---
    // Note : filteredTransactions ne contient que les transactions du 'selectedDate' (aujourd'hui par défaut)
    ...
    // CORRIGÉ : Erreur de copier-coller ici
                            ...
                            <main className="main-page-content">
                                <div className="app-container home-page-container">
                                    <HomePage
                                        ...
                                        token={token} // <-- Passe le token
                                        transactionsDuJour={filteredTransactions} // <-- Passe les transactions du jour
                                    />
                                </div>
                            </main>
                        </div>
